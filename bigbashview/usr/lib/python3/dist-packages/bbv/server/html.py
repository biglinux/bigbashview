...
<html>
    <head>
        <title>Welcome to BigBashView</title>
        <style>
        html, body{
            margin: 0;
            background: #2b303b;
                ...
                <div class="socialinfo">
                    ...
                    <div class="socialtwo">
                        <div class="instruction">
                            ...
                            <a href="#!" style='text-decoration:none' onclick="_run('xdg-open https://github.com/biglinux/bigbashview')">
...
''' % (LOGO, APP_VERSION, os.uname()[1], os.environ.get('XDG_CURRENT_DESKTOP'))
